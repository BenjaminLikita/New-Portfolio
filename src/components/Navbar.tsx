...
const Navbar = () => {
  ...
  return (
    <>
      <motion.nav initial={{ y: -20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="fixed top-2 md:top-5 left-[2%] md:left-[10%] bg-gray-1 w-[95%] md:w-[80%] rounded-[50px] border border-gray-2 m-auto py-3 px-7 z-[30] flex justify-between items-center gap-5">
